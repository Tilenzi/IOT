...
void setup() {
  ...
  for(int led = 7; led <= 12; led++){
	...
	pinMode(3, OUTPUT);
  // Definir a seed do gerador de nÃºmeros aleatÃ³rios
...
void loop() {
  ...
  switch (stateGame) {
    case 0:
      // inicio de jogo
      Serial.println("* Jogo da Memória - Você é bom ? *");
      Serial.println("Comecar? (sim/nao)");
      leserial();
    ...
    case 1:
      ...
      if (recebido == sequenciaNumerica){
        ...
        stateGame = 7;
        Serial.println("Mais sorte na proxima"); 
        piscaled(300,5);     
      }
      break;
    case 2:
	...
	// Nivel 3
      ...
      if (recebido == sequenciaNumerica){
        ...
        stateGame = 7;
        Serial.println("Mais Sorte na Próxima"); 
        piscaled(300,5);     
      }
      break;
	case 4:
    ...
    case 7:
      ...
      break;
    case 8:
      Serial.println("Jogar novamente? (sim/nao)"); 
      leserial();
      if (recebido.equalsIgnoreCase("sim")){
        stateGame = 1;
        Serial.println("Vamos nessa !!");
        piscaled(1000,3);
      } else {
        stateGame = 3;
        Serial.println("Que Pena"); 
